   ...
   return (
       <div style={{ width: "100%" }}>
          <div className="slideshow">
             <div className="slideshow-image" style={{ backgroundImage: "url('./images/istockphoto-155439315-1024x1024.jpg')" }}></div>
             <div className="slideshow-image" style={{ backgroundImage: "url('./images/istockphoto-962445754-1024x1024.jpg')" }}></div>
             <div className="slideshow-image" style={{ backgroundImage: "url('./images/istockphoto-1045339232-1024x1024.jpg')" }}></div>
             <div className="slideshow-image" style={{ backgroundImage: "url('./images/istockphoto-1058063486-1024x1024.jpg')" }}></div>
          </div>
